...
l_prodotto = len(prodotto)

Descrizione = input("Inserisci la desriione del prodotto: ")
l_descrizione = len(Descrizione)

print(f"Prodotto: {prodotto}, Lunghezza: {l_prodotto}")
print(f"Descrizione: {Descrizione}, Lunghezza: {l_descrizione}")
