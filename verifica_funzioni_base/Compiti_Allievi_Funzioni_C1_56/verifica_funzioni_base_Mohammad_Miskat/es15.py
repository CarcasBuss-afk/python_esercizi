...
nome_cliente = input("inseriscri nome cliente: ")
nome_prodotto = input("inseriscri nome prodotto: ")
prezzo = float (input("inseriscri il prezzo: "))
quantita_r = int (input("inseriscri la quantita richiesta: "))
sconto = int (input("inseriscri lo sconto: "))
Q_in_magazzino = int (input("inseriscri quantità in magazzino: "))
stampa_ordine(nome_cliente, nome_prodotto, quantita_r)

calcola_totale(prezzo, quantita_r, sconto)

verifica_disponibilita(quantita_r, Q_in_magazzino)
