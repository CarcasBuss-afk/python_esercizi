...
nome_in = input("Inserisci il nome: ")
nome = str (nome_in)
ore_in = input("Inserisci le ore settimanali: ")
ore_settimanali = int (ore_in)
anni_in = input("Inserisci Anni di esperienza: ")
anni_esperienza = int (anni_in)
