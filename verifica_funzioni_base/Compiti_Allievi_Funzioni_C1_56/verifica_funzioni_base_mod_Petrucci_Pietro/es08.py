...
ore_input = input("Inserisci le ore che hai fatto in questa settimana: ")
ore_settimanali = int (ore_input)
calcola_costo_mensile(ore_settimanali)

anni_input = input("Inserisci il totale di quanti anni di esperienza hai: ") 
anni_esperienza = int (anni_input)
